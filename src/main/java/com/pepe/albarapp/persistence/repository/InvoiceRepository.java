...
public interface InvoiceRepository extends PagingAndSortingRepository<Invoice, Long> {
	...
	@Query("select new com.pepe.albarapp.service.dto.InvoiceDto(i.id, i.issuedTimestamp, i.customer.id, i.customer.code, i.customer.alias, i.customer.name, i.customer.fiscalId, SUM(dni.quantity*dni.price*(1+dni.product.tax/100)), SUM(dni.quantity)) " +
