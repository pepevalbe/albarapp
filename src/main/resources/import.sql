INSERT INTO product(id, code, name, factory_price) VALUES 
	(1, 1, 'Bandeja - Huevo XL - 20uds', 3.6),
	(2, 2, 'Bandeja - Huevo L - 30uds', 5.1),
	(3, 3, 'Bandeja - Huevo M - 30uds', 4.8),
	(4, 4, 'Bandeja - Huevo S - 30uds', 4.5),
	(5, 5, 'Estuche - Huevo S - 10uds', 1.5), 
	(6, 6, 'Estuche - Huevo S - 6uds', 0.9), 	
	(7, 7, 'Gallina', 4);
...
INSERT INTO invoice(id, invoice_number, issued_timestamp) VALUES
    (1, 201900001, 1569173243000),
    (2, 201900002, 1569173243000),
    (3, 201900003, 1569173243000);
